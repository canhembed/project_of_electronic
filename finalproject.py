...
class App(QMainWindow):
    ...
    def on_info_firebase(self,x):
    	...
    	# if err == 0:
    	# 	buttonReply=QMessageBox.question(self,'ERROR','Mất kết nôi!!',QMessageBox.Yes|QMessageBox.No,QMessageBox.Yes)
    	# 	if buttonReply==QMessageBox.Yes:
    	# 		err=0
    	# 	else:
    	# 		err=0
    	# if err == 1:
    	# 	buttonReply=QMessageBox.question(self,'ERROR','Đã kết nôi!!',QMessageBox.Yes|QMessageBox.No,QMessageBox.Yes)
    	# 	if buttonReply==QMessageBox.Yes:
    	# 		pass
    ...
    def Load_Data_Hours(self):
    	...
    	self.MyThread.start()
    	self.MyThread.sig1.connect(self.on_info)
